...
It generates color for every slug which is specified in `data/simpleicons.json` file
using `simple-icons/simple-icons` repo data.

Visit to simple-icons website: https://simpleicons.org
"""
...
SIMPLEICONS_CSS_PATH = Path("/Users/amananand/PycharmProjects/Blog/docs/stylesheets/simpleicons.css")
...
def generate_css(all_icons_dict: dict[str, str], slugs_set: set[str]) -> str:
    """Generates CSS for each slug."""
    css_lines = [
        "/*\n😎 Generated by 'docs_src/generate_simpleicons_css.py'\n*/",
        "",
    ]
    for slug in sorted(slugs_set):
        color = all_icons_dict.get(slug, "var(--md-typeset-color)")
